...
OPERATOR_GROUPS = {
    ...
    "iliad_group": {
        ...
        "markets_count": 3,
        "notes": "Founded by Xavier Niel. Operates Free (France), Iliad (Italy), Play (Poland). NJJ Holding (Niel's personal vehicle) also controls Salt (Switzerland), eir (Ireland).",
    },
    "orange_group": {
