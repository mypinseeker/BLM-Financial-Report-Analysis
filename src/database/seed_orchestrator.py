"""Seed orchestrator — seeds all 12 markets into a single SQLite DB.

Used by cli_group_local.py and cli_push_all.py to prepare a complete
local database with Germany, Chile, and 10 LATAM Millicom markets.
"""
...
def seed_all_markets(db_path: str = ":memory:") -> TelecomDatabase:
    """Seed all 12 markets into a single SQLite database.
